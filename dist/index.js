...
const upload_assets_1 = __nccwpck_require__(7511);
function run() {
...
const klaw_sync_1 = __importDefault(__nccwpck_require__(9036));
const promise_pool_1 = __importDefault(__nccwpck_require__(8465));
...
function getBaseUrl() {
    ...
    if (!url)
        throw ReferenceError('필수 환경변수가 비어있습니다.');
    if (url.endsWith('/'))
        url = url.slice(0, -1);
    return url;
}
function getAuthToken() {
    ...
    if (!token)
        throw ReferenceError('토큰이 비어있습니다.');
    return token;
}
...
function uploadAssets(sourceDir, destinationDir, concurrency, bucket) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const paths = (0, klaw_sync_1.default)(sourceDir, {
            nodir: true
        });
        ...
        const uploadTargets = paths
            ...
            return {
                ...
                contentType: (0, mime_types_1.lookup)(p.path) || 'text/plain',
